...
const categories = ["All", "Curries", "Paneer", "Lentils & Pulses", "Snacks & Sides"];
...
const products = [
    {
        ...
        name: "Paneer Tikka",
        category: "Paneer",
        image: "/images/rtefood/paneer-tikka.jpg",
        shortSpec: "Marinated cottage cheese | Tandoor-style | 250g / 500g retort pouches",
        tags: ["Vegetarian", "Halal"],
        moq: "500 cartons",
        description:
            "Tender cubes of cottage cheese marinated in a smoky tandoor-style spiced yoghurt sauce. Ready in 3 minutes, ideal for retail and food-service markets globally.",
        specs: {
            ingredients: "Paneer, Yoghurt, Spices",
            shelfLife: "18 months",
            dietary: "Vegetarian / Gluten-Free",
            packSize: "250g / 500g",
            packaging: "Retort Pouch / Glass Jar",
            certification: "HACCP / FSSAI",
        },
    },
    {
        id: 2,
        ...
        image: "/images/rtefood/dal-tadka.jpg",
        shortSpec: "Yellow lentils | Tempered spices | 300g / 500g retort pouches",
        tags: ["Vegan", "High Protein"],
        moq: "500 cartons",
        description:
            "Classic North Indian yellow dal tempered with mustard seeds, cumin, dried red chillies, and ghee. A wholesome comfort meal shipped shelf-stable worldwide.",
        specs: {
            ingredients: "Yellow Lentils, Ghee, Whole Spices",
            shelfLife: "18 months",
            dietary: "Vegan Option Available",
            packSize: "300g / 500g",
            packaging: "Retort Pouch / Aseptic Pack",
            certification: "HACCP / FSSAI / Halal",
        },
    },
    {
        id: 3,
        name: "Chana Masala",
        category: "Lentils & Pulses",
        image: "/images/rtefood/chana-masala.jpg",
        shortSpec: "Chickpeas in tangy tomato gravy | 300g / 500g | Vegan-friendly",
        tags: ["Vegan", "High Protein"],
        moq: "500 cartons",
        description:
            "Slow-cooked chickpeas in a bold, tangy tomato and onion masala. A high-protein vegan dish that travels well — popular in European and North American markets.",
        specs: {
            ...
            packSize: "300g / 500g",
            packaging: "Retort Pouch / Glass Jar",
            certification: "HACCP / FSSAI / Kosher",
        },
    },
    {
        id: 4,
        name: "Kaju Masala",
        category: "Curries",
        image: "/images/rtefood/kaju-masala.jpg",
        shortSpec: "Cashews in rich cream gravy | 250g / 500g | Premium SKU",
        tags: ["Vegetarian", "Premium"],
        moq: "300 cartons",
        description:
            "Whole cashew nuts simmered in a velvety cream and tomato-based sauce with aromatic whole spices. A premium offering suited for fine-dining ready meal ranges.",
        specs: {
            ingredients: "Cashews, Cream, Tomato, Spices",
            shelfLife: "12–18 months",
            dietary: "Vegetarian / Gluten-Free",
            packSize: "250g / 500g",
            packaging: "Glass Jar / Retort Pouch",
            certification: "HACCP / FSSAI / Halal",
        },
    },
];

const shippingTerms = ["FOB Mumbai / Chennai", "CIF Destination Port", "DDP as negotiated"];
                ...
                <div className="container-custom relative z-10">
                    ...
                    >
                        ...
                        <p className="text-gray-300 text-lg max-w-2xl">
                            Shelf-stable Indian meals engineered for global retail — HACCP-certified, Halal-ready,
                            and packaged for 18–24 month shelf life.
                        </p>
                    </motion.div>
                </div>
            </section>
                            ...
                            >
                                ...
                                <div className="relative md:w-[40%] flex-shrink-0 min-h-[220px] md:min-h-0 bg-navy">
                                    <img
                                        ...
                                        onError={(e) => {
                                            (e.target as HTMLImageElement).src =
                                                "https://images.unsplash.com/photo-1585937421612-70a008356fbe?w=800&q=70";
                                        }}
                                    />
                                            ...
                                            <div className="px-6 py-4">
                                                ...
                                                <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
                                                    {([
                                                        ...
                                                        { icon: ShieldCheck, label: "Dietary",       key: "dietary"       },
                                                        { icon: Weight,      label: "Pack Size",     key: "packSize"      },
                                                        { icon: Box,         label: "Packaging",     key: "packaging"     },
                                                        { icon: Flame,       label: "Certification", key: "certification" },
                        ...
                        <div className="flex-1">
                            ...
                            <div className="grid grid-cols-3 sm:grid-cols-5 gap-4">
                                {[
                                    ...
                                    { file: "fssai.png",    label: "FSSAI Export License"           },
                                ].map(({ file, label }) => (
                                    <div
                                        key={file}
