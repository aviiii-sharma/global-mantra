...
const featuredProducts = [
  ...
  },
  {
    ...
    grade: "Aged / Steam Processed",
    spec: "GI Tagged | Extra long grain | Punjab origin",
    tag: "High Demand",
    tagColor: "bg-blue-500",
    image: "https://images.unsplash.com/photo-1536304993881-ff86e0c9c350?w=400&q=70",
    href: "/products/agro",
  },
  {
  ...
  },
  {
    ...
    spec: "500–2000 kg | 4-loop & baffle | Custom print",
    tag: "Industrial",
...
const testimonials = [
  ...
  },
  {
    ...
    country: "Germany",
    flag: "🇩🇪",
    quote: "We source FIBC jumbo bags and PP woven sacks from them quarterly. Quality is consistent, the team responds fast, and pricing stays competitive even with large volumes.",
    rating: 5,
  },
];
