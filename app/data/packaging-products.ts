...
export const products: PackagingProduct[] = [
    ...
    {
        id: 3,
        slug: "pp-bag-without-liner",
        name: "PP Bag Without Liner",
        category: "PP Woven",
    ...
    {
        id: 4,
        slug: "pp-bags-with-liner",
        name: "PP Bags With Liner",
        category: "PP Woven",
    ...
    {
        id: 5,
        slug: "pp-gusseted-bag",
        name: "PP Gusseted Bag",
        category: "PP Woven",
    ...
    },
    {
        ...
        moq: "10,000 pcs",
        description:
            "BOPP Bags with highest quality prints. Ideal for flour, cement, and grain packaging.",
        specs: {
            material: "PP (PolyPropylene)",
            mesh: "9×9 to 14×14",
            fabricColour: "White / Natural / Checks / Any Color",
    ...
    {
        id: 7,
        slug: "pp-laminated-valve-bag",
        name: "PP Laminated Valve Bag",
        category: "PP Woven",
    ...
    {
        id: 11,
        slug: "pp-box-type-square-bag",
        name: "PP Box Type Square Bag",
        category: "PP Woven",
